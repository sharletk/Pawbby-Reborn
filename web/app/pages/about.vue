<template>
  <div class="flex flex-col min-h-screen pb-10 px-4 pt-6">
    ...
    <div class="flex flex-col items-center mb-12">
      ...
      <p class="text-pawbby-muted text-sm tracking-widest font-medium">V{{ version }}</p>
    </div>
    ...
    <div class="mt-auto text-center pt-8 text-pawbby-muted text-sm">
      Created with ❤️ by
      <a href="https://speetjens.net" target="_blank" rel="noopener noreferrer"
        class="hover:text-white transition-colors" style="font-family: serif; font-weight: bold;">Speetjens.net</a>
      & community
    </div>
