<template>
  <div class="flex flex-col min-h-screen pb-10 px-4 pt-6">
    ...
    <div class="space-y-6">
      ...
      <!-- Unit of Weight -->
      <button @click="toggleWeightUnit" class="w-full flex items-center justify-between text-white/90 hover:text-white group">
        ...
        <div class="flex items-center space-x-2">
          <span class="text-sm text-pawbby-mutedDark group-hover:text-pawbby-muted transition-colors uppercase">{{ user?.weightUnit || 'kg' }}</span>
    ...
    <div class="mt-auto pt-8 pb-4">
      <button @click="doClearCache" class="w-full text-center py-4 text-[#D84C4C] font-semibold text-lg hover:bg-white/5 rounded-2xl transition-colors">
